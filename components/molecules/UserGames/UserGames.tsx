...
import {GameCardProps} from '../UserGameCard/UserGameCard'


const UserGames:React.FC<GameCardProps> = ({gameName, gameImg, elo, eloImg, role, roleImg}) => {
  return (
    <div className={styles.userGames}>
        ...
        <div className={styles.userGames__games}>
            <UserGameCard gameImg={gameImg} gameName={gameName} elo={elo} eloImg={eloImg} roleImg={roleImg} role={role}/>
        </div>
    </div>
  )
}
